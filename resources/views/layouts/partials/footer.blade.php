    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <h3 class="text-2xl font-bold mb-4">{{ config('app.name', 'NonProfit') }}</h3>
                <p class="text-gray-400 mb-4 max-w-md">
                    Making a difference in our community through dedicated programs, events, and volunteer opportunities.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('public.posts.index') }}" class="text-gray-400 hover:text-white transition">News & Blog</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li class="flex items-start">
                        <svg class="h-5 w-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        <span>123 Nonprofit Street<br>City, State 12345</span>
                    </li>
        ...
        <div class="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">
                &copy; {{ date('Y') }} {{ config('app.name', 'NonProfit') }}. All rights reserved.
            </p>
